...
| 2 | Audit `companion_spell_sets` for the Druid 3192/3447 mis-tag (tagged Snare 128 but effect is Root, should be type 4). Optional correction; gate handles both via unified helper. | data-expert | Complete (2026-05-03) | Both rows corrected. Broader audit: Root direction clean; Bard 1758 false positive confirmed correct. Migration at `data-expert/context/02-fix-druid-roots-mistag.sql`. |
