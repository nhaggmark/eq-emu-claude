...
| 67 | **Phase 5b: Aten Destroy DT disposition.** Spell 1948 "Destroy" (-100k HP, 0 mana, 0 cast, 0 recast) in npc_spells_entries list 229, used by 158006 #Aten_Ha_Ra "Destroy form" only. Aten_Trigger script (158095) gates which form spawns: 158006 if any of 9 inner-VT bosses alive; 158096 (no Destroy) if all dead. **Architect recommends Option A — PRESERVE** (rely on script-gate; Decision #11 + Phase 4b Kerafyrm Decision #12 precedent — same spell ID 1948 in list 489 preserved). **Alternative Option B — DELETE** (absolute safety; Decision #16/#54 precedent, removes script-gate punishment effect). | architect | 2026-04-25 | **USER APPROVAL REQUIRED.** |
