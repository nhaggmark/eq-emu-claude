...
| 36 | Phase 4b: Warder scaling (128090/91/92/93 + Final Arbiter alt 128045) — Option A (scale to 60k HP, awake event reachable for small group with Kerafyrm consequence preserved, **architect + lore-master joint recommendation**) or Option B (leave at 200k HP, awake event mathematically unreachable for small group)? | architect | user | **Pending 2026-04-23** | Architect + lore-master recommendation: Option A. See architect/velious-b-architecture.md §Kerafyrm Isolation Proof + §Lore-master 2026-04-23 addendum for lore analysis. |
