# Companion Authenticity Fixes — Status Tracker
...
Companion Authenticity Fixes — Fix critical and major gaps: critical hits (GAP-01), PC-only spell targeting (GAP-02), defensive skills (GAP-03), stat differentiation (GAP-04), shaman spell priorities (GAP-05), class-neutral melee damage (GAP-06).
