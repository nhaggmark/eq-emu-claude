...
**Acceptance criterion:** _Companion hit by a damage shield does not enter INVULNERABLE state_

**Prerequisite:** _Active companion, fight a mob with a damage shield buff_
...
**Acceptance criterion:** _Go Away button on charmed mob dismisses correctly_

**Prerequisite:** _Active charmed companion_
...
**Acceptance criterion:** _Companion mana regenerates at the expected rate_

**Prerequisite:** _Active companion with mana pool_
