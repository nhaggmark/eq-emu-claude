# Companion Authenticity Phase 3-4 — Status Tracker
...
Companion Authenticity Phase 3-4 — Polish and data tuning fixes: GAP-07 (spell list audit), GAP-08 (gear progression), GAP-09/10 (attack tuning), GAP-12 (commentary channel), GAP-13 (level-up dialogue), GAP-14 (re-recruitment text), GAP-17 (luabind inheritance).
...
|---|------|-------|--------|-------|
| GAP-12 | Fix commentary channel to use group chat | lua-expert | Complete | companion_commentary.lua |
| GAP-13 | Add level-up LLM dialogue handler | lua-expert | Complete | global_npc.lua |
| GAP-14 | Resolve re-recruitment bonus text vs behavior | lua-expert | Complete | companion.lua |
